...
export const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 z-50 w-full bg-dark-blue-d'>
      <nav className='flex items-center justify-between h-20 mx-6 xl:mx-auto xl:max-w-[1200px]'>
        <a href='#'>
        ...
        >
          <ul className='font-raleway flex flex-col items-center gap-y-6 md:flex-row md:gap-x-12'>
            <li>
              <a href='#'>Features</a>
            </li>
            <li>
        ...
        <div onClick={handleToggleNav} className='md:hidden'>
